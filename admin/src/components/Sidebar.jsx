  ...
  return (
    <>
      ...
      <div className="md:hidden bg-[#1A130E] text-[#ECE7E0] p-4 flex justify-between items-center sticky top-0 z-50 border-b border-[#332A21]">
        <h2 className="font-serif font-bold tracking-widest text-[#C49A6C] text-lg uppercase">
          CELESTÉ
        </h2>
        <button
          onClick={() => setIsOpen(!isOpen)}
          className="p-2 bg-[#261C15] rounded-xl border border-[#332A21] text-[#B5A89A]"
        >
      ...
      {isOpen && (
        <div
          className="fixed inset-0 bg-black/50 backdrop-blur-xs z-[99] md:hidden"
      ...
      >
        ...
        <div className="p-6 border-b border-[#2C211A] hidden md:block">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h2 className="font-serif font-bold text-lg tracking-widest text-[#ECE7E0] uppercase">
                CELESTÉ HOUSE
              </h2>
              <p className="text-[9px] text-[#C49A6C] tracking-[0.2em] font-extrabold uppercase mt-0.5">
        ...
        <nav className="flex-1 mt-8 px-4 space-y-2 overflow-y-auto custom-scrollbar">
          <div className="px-3 flex items-center gap-1.5 mb-3">
            ...
            <p className="text-[9px] font-black text-[#5C4D41] uppercase tracking-[0.2em]">
              Hệ thống quản lý
            </p>
          </div>
              ...
              return (
                <li key={item.id} className="mb-1.5">
                  ...
                  >
                    ...
                    <span
                      className={`transition-transform duration-300 group-hover:scale-110 ${isActive ? "text-[#C49A6C]" : "text-[#5C4D41] group-hover:text-[#918173]"}`}
                    >
                      {item.icon}
                    </span>
      ...
      {confirmDialog.isOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs flex justify-center items-center z-[100] p-4">
          <div className="bg-[#1A130E] border border-[#2C211A] rounded-2xl w-full max-w-sm overflow-hidden p-8 text-center shadow-2xl">
            ...
            <h3 className="text-lg font-bold text-[#ECE7E0] mb-1.5">
              {confirmDialog.title}
            </h3>
            <p className="text-xs text-[#918173] mb-6 leading-relaxed">
