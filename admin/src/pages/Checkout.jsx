          ...
          <div className="ck-anim-1 mb-8">
            ...
            >
              ...
              >
                ...
                >
                  Thu ngân:{" "}
                  <strong style={{ color: "#2A1F15" }}>
                    {currentUserName}
                  </strong>
                </span>
                <span style={{ fontSize: 11, color: "#A39688" }}>
                  {currentTime}
                </span>
              </div>
            </div>
              ...
              >
                ...
                <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                  ...
                  >
                    ...
                    <div
                      style={{ fontSize: 12, color: "#A39688", marginTop: 2 }}
                    >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                ...
                >
                  <div
                    style={{
                      ...
                      height: 32,
                      borderRadius: 10,
                      background: "linear-gradient(135deg,#F5EFE7,#EDE2D4)",
                      display: "flex",
                      alignItems: "center",
                  ...
                  <div>
                    ...
                    {customerName.trim() !== "" &&
                      !isValidName(customerName) && (
                        ...
                        >
                          Tên 2–100 ký tự, chỉ chứa chữ cái
                        </p>
                      )}
                  </div>
                  <div>
              ...
              >
                <button
                  ...
                  title={!isFormValid ? "Vui lòng nhập Họ tên và SĐT" : ""}
                  onClick={() => {
                    const now = new Date();
                    ...
                    fetch("/api/payments", {
                      ...
                      .then(() =>
                        fetch(`/api/orders/${invoice?.id}/status`, {
                          method: "PUT",
                          headers: { "Content-Type": "application/json" },
                      ...
                      .then(() =>
                        fetch(`/api/tables/${invoice?.tableId}/status`, {
                          method: "PUT",
                          headers: { "Content-Type": "application/json" },
                      ...
                      .then(() => {
                        if (onPaymentSuccess) onPaymentSuccess(invoice?.id);
                      })
                      .catch((err) => {
          ...
          <div className="ck-invoice-modal">
            ...
            >
              ...
              <div style={{ margin: "16px 0 0" }}>
                ...
                <p
                  style={{ fontSize: 12, color: "#7A6A5A", margin: "0 0 2px" }}
                >
              ...
              >
                {[
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 500, color: "#2A1F15" }}>
                      {val}
                    </span>
                  </div>
                ))}
            ...
            >
              <button className="ck-btn-secondary" onClick={handlePrint}>
                🖨 In hóa đơn
              </button>
              <button
                className="ck-btn-ghost"
