      ...
      <div className="bg-white p-4 md:p-6 rounded-lg shadow-md w-full">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="flex gap-4 flex-1">
            <input
                type="date"
                className="w-full p-2.5 bg-linear-to-r from-blue-50/50 to-transparent rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] border border-gray-200 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all"
            />
            <input
                type="date"
                className="w-full p-2.5 bg-linear-to-r from-blue-50/50 to-transparent rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] border border-gray-200 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all"
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left border border-gray-200">
            ...
            {reservations.map((item) => (
                <tr key={item.reservationId} className="hover:bg-gray-50 border-b">
